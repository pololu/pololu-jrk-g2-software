...
add_license('pololu-jrk-g2-software', 'LICENSE.txt')
...
<body>
<p>
  The Pololu Jrk G2 software distribution is licensed under the GPLv3,
  subject to the restrictions described below.
<p>
  Source code and instructions for building this software can be found in the
  <a href="https://github.com/pololu/pololu-jrk-g2-software">pololu-jrk-g2-software</a> repository.
<p>
  This release was built from
  <a href="https://github.com/pololu/pololu-jrk-g2-software/tree/#{ENV.fetch('commit')}">
  pololu-jrk-g2-software commit #{ENV.fetch('commit')[0, 7]}</a>,
