...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>865960cd-7a9e-4223-913e-5266ca50be16</ProjectGuid>
    <OutputName>pololu-jrk-g2-$(ProductVersion)-win</OutputName>
    <DefineConstants>
      ProductVersion=$(ProductVersion);
      DocumentationUrl=https://www.pololu.com/docs/0J73;
    </DefineConstants>
...
<Wix xmlns="http://schemas.microsoft.com/wix/2006/wi"
  ...
  <Product Name="Pololu Jrk G2"
           Version="$(var.ProductVersion)"
           Manufacturer="Pololu"
           Language="1033"
           UpgradeCode="b1eef0c0-b1e4-4f0d-b721-9c493d88d4b4"
           Id="*">

    <Package Description="Pololu Jrk G2 Installer"
             Manufacturer="Pololu"
             Compressed="yes"
    ...
    <Directory Id="TARGETDIR" Name="SourceDir">
      <Directory Id="ProgramFilesFolder" Name="PFiles">
        <Directory Id="Pololu" Name="Pololu">
          <Directory Id="INSTALLDIR" Name="Jrk G2">
            <Directory Id="BinDir" Name="bin" FileSource="payload/bin/">
              <Component Id="CliExe">
                <File Id="CliExe" Name="jrk2cmd.exe" />
              </Component>
              <Component Id="GuiExe">
                <File Id="GuiExe" Name="jrk2gui.exe" KeyPath="yes">
                  <Shortcut Id="GuiShortcut" Directory="PololuMenuFolder"
                            Name="Jrk G2 Configuration Utility"
            ...
            <Component Id="DocumentationUrl" Guid="a1994ea8-48e3-4d73-8293-2d36e43491da">
              <util:InternetShortcut Id="DocumentationUrl" Type="url"
                                     Name="Jrk G2 online documentation"
    ...
    <CustomAction Id="InstallInf1.SetProperty"
                  Property="InstallInf1" Value="[INSTALLDIR]drivers\\jrk-g2.inf" />

    <CustomAction Id="InstallInf2" Impersonate="no" Execute="deferred" Return="check"
                  BinaryKey="InstallHelper" DllEntry="libusbp_install_inf" />
    <CustomAction Id="InstallInf2.SetProperty"
                  Property="InstallInf2" Value="[INSTALLDIR]drivers\\jrk-g2-serial.inf" />

    <CustomAction Id="InstallInf3" Impersonate="no" Execute="deferred" Return="check"
                  BinaryKey="InstallHelper" DllEntry="libusbp_install_inf" />
    <CustomAction Id="InstallInf3.SetProperty"
                  Property="InstallInf3" Value="[INSTALLDIR]drivers\\jrk-g2-bootloader.inf" />

    <InstallExecuteSequence>
      <Custom Action="InstallInf1.SetProperty" After="InstallFiles" />
      <Custom Action="InstallInf1" After="InstallInf1.SetProperty">
        (NOT Installed) OR REINSTALLMODE</Custom>
      <Custom Action="InstallInf2.SetProperty" After="InstallFiles" />
      <Custom Action="InstallInf2" After="InstallInf2.SetProperty">
        (NOT Installed) OR REINSTALLMODE</Custom>
      <Custom Action="InstallInf3.SetProperty" After="InstallFiles" />
      <Custom Action="InstallInf3" After="InstallInf3.SetProperty">
        (NOT Installed) OR REINSTALLMODE</Custom>
...
<WixLocalization Culture="en-us" xmlns="http://schemas.microsoft.com/wix/2006/localization">
  <String Id="WelcomeDlgDescription">The Setup Wizard will install the software and drivers for the Jrk G2 USB Motor Controllers with Feedback on your computer (version [ProductVersion]).  Click Next to continue or Cancel to exit the Setup Wizard.</String>
  ...
  <String Id="ModifyPathDlgNote">This is not required but will make it easier to run jrk2cmd from the Command Prompt.</String>
</WixLocalization>
EOF
end
...
"$SIGNTOOL" sign $SIGNFLAGS -d "Pololu Jrk G2 Setup" *.msi
EOF
end
