...
File.open(PathDir + '99-pololu-jrk2', 'w') do |f|
...
Pololu Jrk G2 USB Motor Controllers with Feedback
on your computer.
<p>
This package will install two programs:
<ul>
<li>Pololu Jrk G2 Configuration Utility (jrk2gui)
<li>Pololu Jrk G2 Command-line Utility (jrk2cmd)
</ul>
EOF
end
