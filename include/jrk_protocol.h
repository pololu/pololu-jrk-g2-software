...
#define JRK_SETTING_MAX_CURRENT_EXCEEDED_THRESHOLD 0x3A
...
#define JRK_MIN_ALLOWED_CURRENT_OFFSET_CALIBRATION -3200
#define JRK_MAX_ALLOWED_CURRENT_OFFSET_CALIBRATION 3200
