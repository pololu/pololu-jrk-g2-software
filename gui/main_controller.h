...
public:
  ...
  void handle_pid_proportional_input(uint16_t multiplier, uint16_t exponent);
  void handle_pid_integral_input(uint16_t multiplier, uint16_t exponent);
  void handle_pid_derivative_input(uint16_t multiplier, uint16_t exponent);
