...
void main_controller::handle_settings_changed()
{
  ...
  window->set_hard_overcurrent_threshold(settings.get_hard_overcurrent_threshold());
...
void main_controller::handle_hard_overcurrent_threshold_input(uint8_t threshold)
{
  if (!connected()) { return; }
