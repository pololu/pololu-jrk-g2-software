...
// completion. In this subclass, each character entered is validated, when entered,
// immediately, based on assigned parameters and the input is not accepted if "Invalid".
