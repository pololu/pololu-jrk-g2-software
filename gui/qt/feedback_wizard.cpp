  ...
  : QWizard(parent), controller(controller)
{
  ...
  connect(button(NextButton), &QAbstractButton::clicked, this, &feedback_wizard::handle_next);
  disconnect(button(BackButton), &QAbstractButton::clicked, 0, 0);
  connect(button(BackButton), &QAbstractButton::clicked, this, &feedback_wizard::handle_back);
...
QGroupBox * feedback_wizard::setup_motor_control_box()
{
  ...
  connect(reverse_button, &QAbstractButton::pressed, this, &feedback_wizard::reverse_button_pressed);
  connect(reverse_button, &QAbstractButton::released, this, &feedback_wizard::drive_button_released);

  forward_button = new QPushButton(tr("Drive forward"));
  connect(forward_button, &QAbstractButton::pressed, this, &feedback_wizard::forward_button_pressed);
  connect(forward_button, &QAbstractButton::released, this, &feedback_wizard::drive_button_released);
  ...
  connect(duty_cycle_input, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged),
...
nice_wizard_page * feedback_wizard::setup_conclusion_page()
{
  ...
  connect(final_error_max_spinbox, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged),
    this, &feedback_wizard::update_order_warning);
  connect(final_max_spinbox, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged),
    this, &feedback_wizard::update_order_warning);
  connect(final_min_spinbox, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged),
    this, &feedback_wizard::update_order_warning);
  connect(final_error_min_spinbox, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged),
    this, &feedback_wizard::update_order_warning);
